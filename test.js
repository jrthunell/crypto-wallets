...
setTimeout(function(){
	...
	**/
	...
	setTimeout(function(){
		...
		consoleOutput = []
		console.log = function(obj){consoleOutput.push(obj)}
		cli.parseArgs(['verify', 'xmr', 'excess yacht cogs avoid shyness plotting mews nocturnal value vigilant tweezers oilfield girth dexterity does axle girth mime acidic rarest aunt juggled point python vigilant',
		...
		cli.parseArgs(['verify', 'xmr', 'acidic yacht cogs avoid shyness plotting mews nocturnal value vigilant tweezers oilfield girth dexterity does axle girth mime acidic rarest aunt juggled point python vigilant',
		...
		setTimeout(function(){
			assert.equal(consoleOutput[0], "Success: The private key matches the address");
			assert.equal(consoleOutput[1], "Failure: The private key does not match the address");
			assert.equal(consoleOutput[2], "Failure: The private key does not match the address");
